    ...
    : IPlantSpeciesService
{
    ...
    {
        var plantSpecies = await plantSpeciesRepository.GetAllAsync(
            cancellationToken);
    ...
    public async Task<PlantSpeciesDto?> GetByIdAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        var plantSpecies = await plantSpeciesRepository.GetByIdAsync(
            id,
            cancellationToken);
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var plantSpecies = PlantSpeciesEntity.Create(
            commonName: command.CommonName,
            scientificName: command.ScientificName,
            description: command.Description,
            sunlightRequirement: command.SunlightRequirement,
            sunlightInstructions: command.SunlightInstructions,
